(() => {
  ...
  var polyfly = {
    ...
    setFeatureValue(name, key, value) {
      ...
      if (key in features[name].settings)
...
`;
  ...
  function useWindowManager() {
    ...
    const raise = (0, import_react6.useCallback)((cat) => {
      setZIndices((prev2) => {
        if (prev2[cat] === zCounter.current)
          return prev2;
        return { ...prev2, [cat]: ++zCounter.current };
      });
    }, []);
    const startDrag = (0, import_react6.useCallback)((cat, e) => {
      ...
      function onUp() {
        ...
        if (d)
          setPositions((prev2) => ({ ...prev2, [d.cat]: { x: d.x, y: d.y } }));
      }
  ...
  function SettingSlider({ featureName, settingKey, def, value }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "py-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex justify-between items-center mb-1.5 text-[12px] text-pf-text-dim", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-pf-text font-mono", children: value })
      ] }),
  ...
  function PhysicsIcon({ size = 16, className = "" }) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Svg, { size, className, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "8", stroke: "currentColor", strokeWidth: "2" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "2.4", fill: "currentColor" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 4v3M12 17v3M4 12h3M17 12h3", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" })
    ] });
  }
  function MiscIcon({ size = 16, className = "" }) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Svg, { size, className, children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "6", cy: "12", r: "1.8", fill: "currentColor" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "1.8", fill: "currentColor" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "18", cy: "12", r: "1.8", fill: "currentColor" })
    ] });
  }
  ...
  function Hud({ features: features2, state: state2, kbds }) {
    ...
    const active = Object.values(features2).filter(
      (f) => state2[f.name] && state2[f.name].active && f.name !== "hud"
    );
    if (active.length === 0)
      return null;
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "div",
      {
        ...
        children: active.map((f) => /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "flex items-center gap-2 text-[12px] leading-snug", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-pf-accent shrink-0" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-white/95 font-medium", children: f.label }),
          kbds.get(f.name) && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "font-mono text-white/55 text-[11px]", children: [
            "[",
            shortenKey2(kbds.get(f.name)),
            "]"
          ] })
        ] }, f.name))
      }
  ...
  function App() {
    const [listeningFor, setListeningFor] = (0, import_react8.useState)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Hud, { features: features2, state: state2, kbds }),
      visible && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "absolute inset-0 bg-black/15 pointer-events-none" }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-pf-accent font-bold tracking-[0.25em] text-[17px] pl-1", children: "POLYFLY" }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "text-[12px] text-pf-text-dim font-mono", children: [
                    totalActive,
                    " active"
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-2 bg-black/35 border border-white/[0.08] rounded-full pl-3 pr-3.5 h-8 focus-within:border-pf-accent/45 transition-colors", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SearchIcon, { size: 15, className: "text-pf-text-dim shrink-0" }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: "text-[11px] text-pf-text-dim/70 pr-1", children: "\u21E7 close" })
                ]
              }
            ),
            categories.map((cat) => {
            ...
            categories.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              "div",
              {
  ...
  function mount() {
    ...
    (0, import_client.createRoot)(mountPoint).render(/* @__PURE__ */ (0, import_jsx_runtime8.jsx)(App, {}));
  }
  var gui = {
    install() {
  ...
  // src/features/instaBrake.js
  var BRAKE_KEYS = ["KeyS", "ArrowDown"];
  var ZERO_VEL = [
  ...
  var instaBrake = {
    ...
    wasm: {
      tickWrites(state2) {
        if (!state2.instaBrake?.active)
          return [];
        return BRAKE_KEYS.some((k) => state2.keys[k]) ? ZERO_VEL : [];
      }
    }
  };

  // src/features/warp.js
  var prev = false;
  var targets = [];
  var idx = 0;
  ...
  function tryWarp() {
    if (!polyfly.physics.isReady() || targets.length === 0)
      return;
  ...
  var warp = {
    ...
    settings: {},
    onState(state2) {
      const cur = !!state2.keys?.[KEYS.warp];
      if (cur && !prev)
        tryWarp();
      prev = cur;
    },
  ...
  var hud = {
    ...
    description: "Show active features as a corner overlay while playing",
    category: "HUD",
    toggleKey: KEYS.hud,
    toggleable: true,
    settings: {}
  ...
  var FEATURES = [mach, instaBrake, warp, pauseTimer, slippy, hud];
